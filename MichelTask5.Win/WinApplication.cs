...
namespace MichelTask5.Win {
    ...
    public partial class MichelTask5WindowsFormsApplication : WinApplication {
        ...
        private void MichelTask5WindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
        ...
        public override IObjectSpace GetObjectSpaceToShowDetailViewFrom(Frame sourceFrame, Type objectType, TargetWindow targetWindow)
        {
            ...
            {
                if (sourceFrame.View.Id == "Work_Order_Tasks_ListView" && objectType == typeof(WoTask))
                {
        ...
        private void MichelTask5WindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
