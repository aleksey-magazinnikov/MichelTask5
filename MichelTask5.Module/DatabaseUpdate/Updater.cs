...
namespace MichelTask5.Module.DatabaseUpdate
{
    ...
    public class Updater : ModuleUpdater
    {
        ...
        public override void UpdateDatabaseAfterUpdateSchema()
        {
            ...
            var workLoad = ObjectSpace.FirstOrDefault<WorkLoad>(o => o.Oid != Guid.Empty) ?? ObjectSpace.CreateObject<WorkLoad>();
            var workGeneration = ObjectSpace.FirstOrDefault<WorkGeneration>(o => o.Oid != Guid.Empty) ?? ObjectSpace.CreateObject<WorkGeneration>();
